...
global.email = 'malindunimsara586@hotmail.com' ;
global.location = 'Kalutara, Sri Lanka' ;
global.timezone  = process.env.TIME_ZONE || 'Asia/Colombo'
global.gurl = 'https://malindunimsara.pages.dev' ; // add your username
global.sudo =  process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : '94767880946'; ;
global.devs = "923184474176"; //Dont change it From here
global.github  = process.env.YOUR_GITHUB || 'https://github.com/DARK-DEVIL-BOTZ/DDEV-BOT';
global.scan  = process.env.QR_URL || 'https://replit.com/@DARK-DEVIL-BOTZ/DDEV-SESSION?v=1';
global.website = 'https://malindunimsara.pages.dev' ; //wa.me/+94700000000
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://i.imgur.com/NpA3ZsJ.jpeg' ;
module.exports = {
  sessionName: process.env.SESSION_ID || "",      //Put Your Session Id Here
  botname: process.env.BOT_NAME || 'ᴅᴅᴇᴠ ʙᴏᴛ',
  botbgm: process.env.BOT_BGM || 'false',
  ownername:  process.env.OWNER_NAME || `ᴍᴀʟɪɴᴅᴜ ɴɪᴍꜱᴀʀᴀ`,
  ...
  caption :process.env.CAPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴅᴅᴇᴠ ʙᴏᴛ*",  
  OPENAI_API_KEY: process.env.OPENAI_API_KEY ||'' ,
  VERSION: process.env.VERSION || 'v.2.0.0',
  LANG: process.env.THEME ? process.env.THEME.toUpperCase() : 'DDEV',
